...
let friendsNames = ["Harry", "Rafay", "Rizwan", "Abdullah"];
...
let friendsList = ["Harry", "Rafay", "Rizwan", "Abdullah"];
for (let index = 0; index < friendsNames.length; index++) {
    console.log("Hi! ${friendsList[i]}, I hope that you are having a fantastic day");
}
//Question no.13
//Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
let ownArray = ["motercyle", "car ", "bicycle", "bus", "train"];
let properties = ["its name is Hyundai Sonata", " it is beautiful and stylish.", " five seater.", " it is very comfortable.", " too much expansive", " it has automatic driving system."];
...
let guest = ["Harry", "Rafay", "Abdullah"];
...
//Missing Person
let personCannotMakeIt = "Abdullah";
...
let placedToVisit = ["Seoul", "Istanbul", "Bangkok", "Beijing", "Kashmir"];
...
let countryList = ["Pakistan", "South Korea", "Thailand", "Turkey", "China"];
...
let userNames = ["Admin", "Eric", "John", "Sam"];
...
let currentUsers = ["Ashraf", "Harry", "Rafay", "Abdullah", "Rizwan"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let newUsers = ["Ashar", "Asjad", "Ahmad", "Rizwan", "Abdullah"];
...
//Question no.34
let myFavoritePizza = ["Peri Peri", "Hot Tandoori", "Cheese Lovers", "Malai Boti"];
...
let magicianNames = ["David ", "Harry Houdini", " Jillette", "Teller"];
...
let magicianNames2 = ["David ", "Harry Houdini", "Jillette", "Teller"];
...
const newArray = ["Sam", "John", "James", "Harry"];
